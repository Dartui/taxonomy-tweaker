	...
	<form action="admin.php?page=taxonomies-tweaker.php" method="post">
		<table class="form-table">
			<tr>
				...
				<td>
					<label for="checked_on_top">
						<input type="hidden" value="0" name="tt[disable_checked_on_top]" />
						<input type="checkbox" value="1" name="tt[disable_checked_on_top]"  id="disable_checked_on_top" <?php echo ($options['disable_checked_on_top'] ? 'checked="checked"' : '') ?> />
			...
			<tr>
				...
				<td>
					<label for="children_with_parent">
						<input type="hidden" value="0" name="tt[children_with_parent]" />
						<input type="checkbox" value="1" name="tt[children_with_parent]"  id="children_with_parent" <?php echo ($options['children_with_parent'] ? 'checked="checked"' : '') ?> />
